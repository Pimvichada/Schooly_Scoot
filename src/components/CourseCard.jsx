...
export default function CourseCard({ course, onClick }) {
  return (
    <div
      onClick={onClick}
      className={`bg-white p-5 rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-indigo-100/50 hover:border-[#BEE1FF] hover:-translate-y-1 transition-all duration-300 cursor-pointer group relative overflow-hidden ${course.isHidden ? 'opacity-70 grayscale-[0.5]' : ''}`}
    >
