...
const AnalyticsView = ({ setView, courses = [], assignments = [], userRole = 'student', userId = null }) => {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] p-4 md:p-8 font-sans animate-in fade-in zoom-in-95 duration-500">
            {/* Top Nav */}
            <div className="flex items-center gap-4 mb-8">
                <button
                    onClick={() => setView('dashboard')}
                    className="p-3 bg-white rounded-2xl shadow-sm hover:bg-gray-50 transition-all border border-slate-100 hover:scale-110 active:scale-95 duration-300"
                >
            ...
            {stats.role === 'teacher' && (
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className={`bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all duration-700 delay-100 ${animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                            ...
                            <h3 className="text-slate-500 font-bold mb-1">งานทั้งหมด</h3>
                            <p className="text-3xl font-black text-slate-800">{stats.totalAssignments}</p>
                            <p className="text-xs text-[#5B9BD5] font-bold mt-2">มอบหมายแล้ว</p>
                        </div>

                        <div className={`bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all duration-700 delay-200 ${animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            ...
                            <h3 className="text-slate-500 font-bold mb-1">ส่งงานเข้ามา</h3>
                            <p className="text-3xl font-black text-slate-800">{stats.totalSubmissions}</p>
                            <p className="text-xs text-[#96C68E] font-bold mt-2">ครั้ง (รวมทั้งหมด)</p>
                        </div>

                        <div className={`bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all duration-700 delay-300 ${animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            ...
                            <h3 className="text-slate-500 font-bold mb-1">ห้องที่ขยันที่สุด</h3>
                            <p className="text-xl font-black text-slate-800 truncate" title={stats.topCourse.name}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className={`lg:col-span-2 bg-white p-6 rounded-3xl shadow-sm border border-slate-100 transition-all duration-1000 delay-300 ${animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                            <h3 className="text-xl font-bold text-slate-800 mb-6">จำนวนการส่งงานรายวิชา</h3>
                        ...
                        <div className={`bg-white p-6 rounded-3xl shadow-sm border border-slate-100 transition-all duration-1000 delay-500 ${animate ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                            <h3 className="text-xl font-bold text-slate-800 mb-6">สถานะงาน</h3>
                            <div className="flex flex-col items-center justify-center relative mb-6">
                                ...
                                >
                                    <div className="w-32 h-32 bg-white rounded-full flex flex-col items-center justify-center shadow-inner">
                                        <span className="text-4xl font-black text-slate-700">{stats.activeAssignments}</span>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between p-3 bg-[#F0FDF4] rounded-2xl border border-[#96C68E]/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm font-bold text-slate-700">มีการส่งงานแล้ว</span>
                                    </div>
            ...
            {stats.role === 'student' && (
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div
                            className={`bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all duration-700 ${animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
                        ...
                        >
                            ...
                            <div className="w-12 h-12 bg-[#F0FDF4] rounded-2xl flex items-center justify-center mb-4 text-[#96C68E] group-hover:scale-110 transition-transform duration-300">
                                <CheckCircle size={24} />
                            </div>
                            <h3 className="text-slate-500 font-bold mb-1">งานที่ส่งแล้ว</h3>
                            <p className="text-3xl font-black text-slate-800">{stats.submissionRate}%</p>
                        ...
                        >
                            ...
                            <div className="w-12 h-12 bg-[#E3F2FD] rounded-2xl flex items-center justify-center mb-4 text-[#5B9BD5] group-hover:scale-110 transition-transform duration-300">
                                <Clock size={24} />
                            </div>
                            <h3 className="text-slate-500 font-bold mb-1">เรียน/สัปดาห์</h3>
                            <p className="text-3xl font-black text-slate-800">{stats.totalStudyHours} ชม.</p>
                        ...
                        >
                            ...
                            <div className="w-12 h-12 bg-[#F3E8FF] rounded-2xl flex items-center justify-center mb-4 text-[#A78BFA] group-hover:scale-110 transition-transform duration-300">
                                <Award size={24} />
                            </div>
                            <h3 className="text-slate-500 font-bold mb-1">วิชาที่ถนัด</h3>
                            <p className="text-xl font-black text-slate-800 truncate" title={stats.hardSkill.name}>
                        ...
                        <div className={`lg:col-span-2 space-y-8 transition-all duration-1000 delay-300 ${animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                            <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
                                <div className="flex justify-between items-center mb-6">
                                    <h3 className="text-xl font-bold text-slate-800">วิเคราะห์คะแนน (เก็บ vs สอบ)</h3>
                        ...
                        <div className={`space-y-6 transition-all duration-1000 delay-500 ${animate ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                            <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 h-full">
                                ...
                                <div className="flex flex-col items-center justify-center relative mb-6">
                                    ...
                                    >
                                        <div className="w-32 h-32 bg-white rounded-full flex flex-col items-center justify-center shadow-inner">
                                            <span className="text-4xl font-black text-slate-700">{stats.submissionTiming.total}</span>
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between p-3 bg-[#F0FDF4] rounded-2xl border border-[#96C68E]/30 hover:scale-105 transition-transform duration-300">
                                        <div className="flex items-center gap-2">
                                            <div className="w-3 h-3 rounded-full bg-[#96C68E]"></div>
                                            <span className="text-sm font-bold text-slate-700">ส่งก่อนเวลา (&gt;1วัน)</span>
                                        </div>
                                        <span className="font-bold text-[#96C68E]">{stats.submissionTiming.early}</span>
                                    </div>

                                    <div className="flex items-center justify-between p-3 bg-[#FFF8E1] rounded-2xl border border-[#FFE787]/50 hover:scale-105 transition-transform duration-300">
                                        <div className="flex items-center gap-2">
                                            <div className="w-3 h-3 rounded-full bg-[#FFE787]"></div>
                                            <span className="text-sm font-bold text-slate-700">ทันเวลา</span>
                                        </div>
                                        <span className="font-bold text-orange-400">{stats.submissionTiming.onTime}</span>
                                    </div>

                                    <div className="flex items-center justify-between p-3 bg-red-50 rounded-2xl border border-red-100 hover:scale-105 transition-transform duration-300">
                                        <div className="flex items-center gap-2">
                                            <div className="w-3 h-3 rounded-full bg-[#FF917B]"></div>
